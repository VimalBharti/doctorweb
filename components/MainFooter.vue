  ...
  <footer class="mt-auto w-full py-2 mx-auto bg-white border-t">
    ...
    <div class="flex items-center justify-between gap-5 px-6">
      ...
      <div class="md:text-end space-x-2">
        <a class="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="https://www.instagram.com/balancedietbynancy?igsh=MXdqNDh3NmFwNjk3MQ==" target="_blank">
          <Icon name="tdesign:logo-instagram" class="h-5 w-5" />
        </a>
        <a class="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="https://www.facebook.com/profile.php?id=61575247379231" target="_blank">
          <Icon name="ri:facebook-fill" class="h-5 w-5" />
        </a>
      </div>
      <!-- End Social Brands -->
    </div>
